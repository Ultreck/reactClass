...
const NavBar = () => {
  ...
  <ul className="navbar-nav flex flex-col md:flex pl-0 list-style-none mr-auto">
    <li className="nav-item p-2">
      <NavLink className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0"  to='/'>Home</NavLink>
    </li>
    <li className="nav-item p-2">
      <NavLink className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to='/questions/:1'>Test</NavLink>
    </li>
    <li className="nav-item p-2">
      <NavLink className="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0" to='/result'></NavLink>
    </li>
  </ul>
